        ...
        const cargarFotos = async () => {
            ...
            for (const autor of autores) {
                try {
                    ...
                    console.error(`Error al obtener la foto para el autor ${autor.id}:`, error);
                }
            }
        ...
        fetch(`http://localhost:8080/api/autor/eliminar/${id}`, {
            ...
            .then(async response => {
                if (response.ok) {
                    ...
                    setNotificationMessage('Error, una o mas noticias utilizan este autor' + response.statusText);
                    setShowNotification(true);
                }
            })
            .catch(error => {
