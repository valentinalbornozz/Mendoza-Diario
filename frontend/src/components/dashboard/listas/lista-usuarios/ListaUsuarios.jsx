        ...
        const cargarImagenes = async () => {
            ...
            for (const usuario of usuarios) {
                try {
                    ...
                    console.error(`Error al obtener la imagen para el usuario ${usuario.id}:`, error);
                }
            }
        ...
        fetch(`http://localhost:8080/api/usuario/eliminar/${id}`, {
            ...
            .then(async response => {
                if (response.ok) {
                    ...
                    setNotificationMessage('Error al eliminar el usuario. Response not ok: ' + response.statusText);
                    setShowNotification(true);
                }
            })
            .catch(error => {
