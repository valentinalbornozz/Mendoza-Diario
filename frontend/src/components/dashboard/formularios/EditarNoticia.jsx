...
const EditarNoticia = ({ id }) => {
  ...
  useEffect(() => {
    ...
    // Fetch the existing data for the given news id and populate the form
    // This assumes you have a function like fetchNoticiaById
    // that fetches the news data for the given id from your API
    // and sets the form values using setValue
    fetchNoticiaById(id)
      .then((noticia) => {
