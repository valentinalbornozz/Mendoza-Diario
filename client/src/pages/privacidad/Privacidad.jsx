...
import SinglePageSlider from "../../components/singlePage/SinglePageSlider";
import "./privacidad.css";

function Privacidad(props) {
  window.scrollTo(0, 0);
  return (
          ...
          <section className="mainContent info">
            <div className="descBot">
              <p>
                ...
                MENDOZA NEWS usa y protege la información que es proporcionada
                por sus usuarios al momento de utilizar su sitio web. Esta
              ...
              <p>
                MENDOZA NEWS está altamente comprometido para cumplir con el
              ...
              <p>
                MENDOZA NEWS Se reserva el derecho de cambiar los términos de la
